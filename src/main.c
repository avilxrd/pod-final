...
int main() {
    ...
    printf("%s->%s lendo o %sarquivo 1%s e inserindo na BST... ", COLOR_YELLOW, COLOR_WHITE, COLOR_GREEN, COLOR_WHITE);
    fflush(stdout);
    raizCursos = lerArq1("data/arq1.txt");
    printf("[%sOK%s]\n", COLOR_GREEN, COLOR_WHITE);


    printf("%s->%s lendo o %sarquivo 3%s e inserindo na BST... ", COLOR_YELLOW, COLOR_WHITE, COLOR_GREEN, COLOR_WHITE);
    fflush(stdout);
